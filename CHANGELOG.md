...
### Fixed
- Chỉnh sửa thông báo cho chính xác hơn (tên rule & số lượng cache rules).
...
### Fixed
- Thêm một chỉnh sửa nhỏ cho chặn bot cURL.

## [1.0.37] - 2026-02-03

### Fixed
- Chỉnh sửa nhỏ về tên rule.

## [1.0.36] - 2026-02-03

### Fixed
- Bổ sung thêm cache_deception_armor vào các phần liên quan đến cache file có .extension để an toàn hơn.
...
### Fixed
- Viết lại hàm gom lỗi Cf trả về tường minh hơn.
- Viết thông báo lỗi cho người dùng cuối rõ ràng hơn.

## [1.0.33] - 2026-01-31

### Fixed
- Chỉ thêm chú thích vào worker, giúp dễ bảo trì mã hơn sau này.
...
### Fixed
- Cải tiến rule liên quan đến wp-json.
- Cải tiến rule liên quan đến chặn file nhạy cảm.

## [1.0.30] - 2026-01-25

### Fixed
- Bảo vệ đơn giản cho wp-json.
