...
const MY_CACHE_RULES = [
  // Rule 1: Cache chung cho HTML (Bài viết, Trang chủ...)
  {
    ...
    "action_parameters": {
      "cache": true,
      "edge_ttl": { "default": 86400, "mode": "override_origin" }, // 1 ngày
